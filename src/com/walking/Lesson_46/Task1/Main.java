package com.walking.Lesson_46.Task1;

import com.walking.Lesson_46.Task1.model.Car;
...
public class Main {
    public static void main(String[] args) {
        ...
        Comparator<Car> numberComparator = (Car o1, Car o2) -> {
        ...
        Comparator<Car> yearComparator = (Car o1, Car o2) ->
                o1.getIdentifier().getYear() - o2.getIdentifier().getYear();
